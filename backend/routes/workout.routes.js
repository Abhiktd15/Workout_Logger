...
import { createWorkout, getAllWorkouts, getWorkoutById,updateWorkout,deleteWorkout, getPreviusWorkouts } from '../controllers/workout.controller.js'
const router = express.Router()

router.use(isAuthenticated)
router.route('/add').post(createWorkout)
router.route('/get').get(getAllWorkouts)
router.route('/previous/get').get(getPreviusWorkouts)
